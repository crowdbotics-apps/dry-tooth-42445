"""
Django settings for dry_tooth_42445 project.
...
ROOT_URLCONF = 'dry_tooth_42445.urls'
...
WSGI_APPLICATION = 'dry_tooth_42445.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dry_tooth_42445 API",
    "DESCRIPTION": "API documentation for dry_tooth_42445 App",
    "VERSION": "v1",
}
